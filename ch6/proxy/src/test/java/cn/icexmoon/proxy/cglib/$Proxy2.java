 ...
 * @Version 1.0
 */
public class $Proxy2 extends Target {
    ...
    public $Proxy2(MethodInterceptor methodInterceptor) {
    ...
    // 初始化
    static {
        METHOD_DO_SOMETHING_PROXY = MethodProxy.create(Target.class, $Proxy2.class, "()V", "doSomething","doSomethingSuper");
        METHOD_DO_SOMETHING_ELSE_PROXY = MethodProxy.create(Target.class, $Proxy2.class, "()V", "doSomethingElse", "doSomethingElseSuper");
        METHOD_PLUS_PROXY = MethodProxy.create(Target.class, $Proxy2.class, "(II)I", "plus", "plusSuper");
    }
