...
public class HowToWorkTests5 {
    ...
    static class $Proxy0 implements DoSomething {
        ...
        public void doSomething() {
            try {
                invokeHandler.invoke(this, DoSomething.class.getMethod("doSomething"), null);
        ...
        public void doSomethingElse() {
            try {
                invokeHandler.invoke(this, DoSomething.class.getMethod("doSomethingElse"), null);
            } catch (RuntimeException | Error e) {
                throw e;
            } catch (Throwable e) {
                throw new UndeclaredThrowableException(e);
        ...
        public int plus(int a, int b) {
            ...
            try {
                Object[] args = {a, b};
                result = (int)invokeHandler.invoke(this, DoSomething.class.getMethod("plus", int.class, int.class), args);
            } catch (RuntimeException | Error e) {
                throw e;
            } catch (Throwable e) {
                throw new UndeclaredThrowableException(e);
